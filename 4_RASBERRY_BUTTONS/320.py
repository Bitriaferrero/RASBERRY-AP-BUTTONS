...
# Form implementation generated from reading ui file '320.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(0, 0, 161, 81))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton.setIconSize(QtCore.QSize(80, 90))
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(0, 80, 161, 61))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_6.setIconSize(QtCore.QSize(50, 120))
        self.pushButton_6.setCheckable(True)
        self.pushButton_6.setChecked(False)
        self.pushButton_6.setFlat(False)
        self.pushButton_6.setObjectName("pushButton_6")
        self.pushButton_8 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_8.setGeometry(QtCore.QRect(160, 0, 161, 41))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_8.setIconSize(QtCore.QSize(25, 70))
        self.pushButton_8.setCheckable(True)
        self.pushButton_8.setChecked(False)
        self.pushButton_8.setFlat(False)
        self.pushButton_8.setObjectName("pushButton_8")
        self.pushButton_10 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_10.setGeometry(QtCore.QRect(160, 40, 161, 41))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_10.setIconSize(QtCore.QSize(25, 70))
        self.pushButton_10.setCheckable(True)
        self.pushButton_10.setChecked(False)
        self.pushButton_10.setFlat(False)
        self.pushButton_10.setObjectName("pushButton_10")
        self.pushButton_11 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_11.setGeometry(QtCore.QRect(160, 140, 161, 101))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_11.setIconSize(QtCore.QSize(40, 70))
        self.pushButton_11.setCheckable(True)
        self.pushButton_11.setChecked(False)
        self.pushButton_11.setFlat(False)
        self.pushButton_11.setObjectName("pushButton_11")
        self.pushButton_12 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_12.setGeometry(QtCore.QRect(0, 140, 161, 51))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_12.setIconSize(QtCore.QSize(50, 90))
        self.pushButton_12.setCheckable(True)
        self.pushButton_12.setChecked(False)
        self.pushButton_12.setFlat(False)
        self.pushButton_12.setObjectName("pushButton_12")
        self.pushButton_13 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_13.setGeometry(QtCore.QRect(0, 190, 161, 51))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_13.setIconSize(QtCore.QSize(50, 60))
        self.pushButton_13.setCheckable(True)
        self.pushButton_13.setChecked(False)
        self.pushButton_13.setFlat(False)
        self.pushButton_13.setObjectName("pushButton_13")
        self.pushButton_7 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_7.setGeometry(QtCore.QRect(160, 80, 161, 61))
...
"font: 81 11pt \"Open Sans ExtraBold\";")
        ...
        self.pushButton_7.setIconSize(QtCore.QSize(50, 120))
...
# EVENTOS BOTONES
        ...
        self.pushButton_7.clicked.connect(self.Play_button_7_clicked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.setText(_translate("MainWindow", "MACCHANGE 1"))
        self.pushButton_13.setText(_translate("MainWindow", "MACCHANGE 2"))
        self.pushButton_7.setText(_translate("MainWindow", "ROUTING ETH0"))
...
# Eventos de botones
    def Play_button_clicked(self):
         os.system("xterm -e 'bash -c \"sudo hostapd /etc/hostapd/hostapd.conf; exec bash\"'")


    def Play_button_7_clicked(self):
          os.system("xterm -e 'bash -c \"sudo iptables -t nat -A POSTROUTING -o wlan0 -j MASQUERADE; exec bash\"'")
          os.system("xterm -e 'bash -c \"sudo echo '1' > /proc/sys/net/ipv4/ip_forward; exec bash\"'") 



          os.system("xterm -e 'bash -c \"sudo iptables -t nat -A POSTROUTING -s 192.168.42.1/8 -o eth0 -j MASQUERADE; exec bash\"'")
